...
var counter = {
    ...
    "week_party_win_rate": function() {
        ...
        var res = [
            [
                ["Premade Win Rate", Games > 0 ? (Win / Games).toFixed(2) * 100 + "%" : '']
            ],
            [
                ["开黑胜率", Games > 0 ? (Win / Games).toFixed(2) * 100 + "%" : '']
            ]
        ]
        return res[lang]
    },
    ...
    "week_max_level": ["Max Level Reached", "最高等级"],
    function() {
    ...
    "2_WinRate": function() {
        ...
        var WinRate = Game ? 0(Win / Games * 100).toFixed(2) : ''
        var res = [
            [
    ...
    "WeekGlobalWin": function() {
        var Win = dataGlobal.PlayerBase.game_win.sum
        var res = [
            [
                ["Global Win", Win + " times"]
            ],
            [
                ["全球胜场", Win + " 局"]
            ]
